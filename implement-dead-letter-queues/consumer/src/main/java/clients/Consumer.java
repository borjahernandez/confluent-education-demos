...
public class Consumer {
  ...
  public static void main(String[] args) {
    ...
    settings.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "{{ BROKER_ENDPOINT }}:9092");
    ...
    settings.put("sasl.jaas.config", "org.apache.kafka.common.security.plain.PlainLoginModule required username=\"{{ CLUSTER_API_KEY }}\" password=\"{{ CLUSTER_API_SECRET }}\";");
